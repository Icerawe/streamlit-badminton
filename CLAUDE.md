...
| 5 | P-  | 🟧 | #FF9800 ส้ม     | Knocker / ผู้ช่วยโค้ช — เกมเร็ว ลูกหนัก วางคม คุมจังหวะ |
| 6 | P   | 🟥 | #F44336 แดง     | Coach — เทคนิคครบ คุมเกมทั้งแมตช์ |
| 7 | P+  | 🔴 | #B71C1C แดงเข้ม | Coach / แข่งระดับประเทศ — เกมเร็วมาก tactics สูง |
