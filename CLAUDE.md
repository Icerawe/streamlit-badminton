...
|-------|------|-------|-----|-----------|
| 0 | BG1 | 🟣 | #CE93D8 ม่วงอ่อน | Beginner 1 — เริ่มเล่นแบดได้ ยังคุมทิศทางไม่สม่ำเสมอ |
| 1 | BG2 | 🟪 | #7986CB ฟ้าม่วง | Beginner 2 — ตีโต้ต่อเนื่องได้ clear มีระยะ เริ่มจับจังหวะ |
| 2 | N   | 🟩 | #4CAF50 เขียว   | Novice — ลูกพื้นฐานครบ เล่นต่อเนื่องได้ ยืนตำแหน่งดีขึ้น |
| 3 | N+  | 🟦 | #2196F3 น้ำเงิน | Novice+ — คุมทิศทางได้ มีรูปเกม วางแผนได้ |
