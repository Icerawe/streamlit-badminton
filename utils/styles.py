...
RANK_DESC = {
    "BG":  "ระดับเริ่มต้น — มือใหม่หัดแข่ง",
    "N-":  "ระดับ Novice — เริ่มแข่งขันได้",
    "N":   "ระดับ Novice — แข่งขันทั่วไป",
    "N+":  "ระดับ Novice สูง — มีทักษะดี",
    "S":   "ระดับ Senior — มีประสบการณ์",
    "P-":  "ระดับ Pro ต่ำ — Knocker / ผู้ช่วย Coach",
    "P":   "ระดับ Pro — Coach",
